...
class CommandManager {
    ...
    static #patchCommandSystem() {
        ...
        this.IconsModule.BOT_AVATARS.ghostclient = "https://github.com/ghostclient.png";
    }
    ...
    static #ensureSection(caller: string) {
        if (!this.#sections.has(caller)) {
            this.#sections.set(caller, {
                ...
                type: 1,
                key: "1",
                icon: caller === "BetterDiscord" ? "https://github.com/ghostclient.png" : null,
                isBD: true
            });
        }
    }
