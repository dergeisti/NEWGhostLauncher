...
const SettingsRenderer = new class SettingsRenderer {
    ...
    async patchModalSettings() {
        ...
        const section = layoutBuilder.section("ghostclient", {
            buildLayout: () => {
            ...
            useTitle: () => Object.assign(<LayerSettingTitle />, {toString: () => "GhostClient"}),
        });
    ...
    public openSettingsPage(key: string) {
        UserSettings?.openUserSettings?.(`ghostclient_${key === "customcss" ? "customcss_tab" : key}_panel`, {
            section: key
        });
    }
