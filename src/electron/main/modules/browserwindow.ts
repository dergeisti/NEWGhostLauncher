    ...
    constructor(options: BrowserWindowConstructorOptions) {
        ...
        if (maybeHasOtherClientMod() && BetterDiscord.clientModCompatibility.shouldShow()) {
            ...
            electron.dialog.showMessageBox({
                type: "warning",
                title: "GhostClient Compatibility Warning",
                message: "GhostClient has detected another client mod. This may cause issues with GhostClient and/or the other mod. Please remove any other client mods to ensure the best experience.",
