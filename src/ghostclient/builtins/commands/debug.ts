...
export default {
    ...
    execute: async (data, {channel}) => {
        ...
        return {content: "Unable to attach your debug info as a file. Please report this issue to GhostClient's [GitHub](https://github.com/GhostClient/GhostClient) if no one else has already done so!"};
    }
};