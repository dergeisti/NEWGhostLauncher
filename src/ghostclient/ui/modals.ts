...
export default class Modals {
    ...
    static async showGuildJoinModal(code: string) {
        ...
        const minimize = Patcher.instead("GhostClient~showGuildJoinModal", DiscordModules.RemoteModule!, "minimize", () => {});
        const focus = Patcher.instead("GhostClient~showGuildJoinModal", DiscordModules.RemoteModule!, "focus", () => {});
