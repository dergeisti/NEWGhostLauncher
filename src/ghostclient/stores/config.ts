...
export default new class ConfigStore extends Store {
    data = {
        ...
        bdPath: process.env.GHOSTCLIENT_DATA_PATH!,
        dataPath: path.join(process.env.GHOSTCLIENT_DATA_PATH!, "data"),
        pluginsPath: path.join(process.env.GHOSTCLIENT_DATA_PATH!, "plugins"),
        themesPath: path.join(process.env.GHOSTCLIENT_DATA_PATH!, "themes"),
        channelPath: path.join(process.env.GHOSTCLIENT_DATA_PATH!, "data", window?.DiscordNative?.app?.getReleaseChannel?.() ?? "stable"),
    };
